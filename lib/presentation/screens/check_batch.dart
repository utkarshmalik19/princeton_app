...
class CheckBatch extends StatefulWidget {
  const CheckBatch({super.key});

  @override
  State<CheckBatch> createState() => _CheckBatchState();
}

class _CheckBatchState extends State<CheckBatch> {
  @override
